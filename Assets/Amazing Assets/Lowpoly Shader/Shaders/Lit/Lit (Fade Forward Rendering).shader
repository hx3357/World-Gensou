Shader "Hidden/Amazing Assets/Lowpoly Shader/Lit (Fade Forward Rendering)"
{
    Properties
    {
...
#include "../cginc/Core.cginc"
        ...
        v2f_surf vert (appdata_full IN) 
        {
          ...
          IN.vertex = SetupLowpolyVertexDisplace(IN);
  ...
  //Curved World
          ...
          float3 eyePos = UnityObjectToViewPos(IN.vertex).xyz;
          half3 viewDir = 0.0;
...
#define LOWPOLY_SHADER_TYPE_TRANSAPRENT
#define LOWPOLY_FLAT_ALL_LIGHTS_NORMALS_AND_POSITION
#include "Lit.cginc"
