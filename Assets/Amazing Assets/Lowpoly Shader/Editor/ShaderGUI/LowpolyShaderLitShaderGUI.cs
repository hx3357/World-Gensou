...
namespace AmazingAssets.LowpolyShader
{
    class LitShaderGUI : ShaderGUI
    {
        ...
        public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
        {
            ...
            shaderType = material.shader.name.Contains("Unlit") ? ShaderType.Unlit : ShaderType.Lit;
        ...
        void SetupShader() 
        {
            ...
            else
            {
                if (renderMode == RenderMode.Opaque)
                    material.shader = Shader.Find("Amazing Assets/Lowpoly Shader/Unlit");
                else
                    material.shader = Shader.Find("Hidden/Amazing Assets/Lowpoly Shader/Unlit (Fade)");
            }
        }
    }
}
