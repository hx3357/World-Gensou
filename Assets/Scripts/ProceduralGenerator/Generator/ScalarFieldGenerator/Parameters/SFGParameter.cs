...
public class SDFIslandSFGParameter
{
    ...
    {
        var newIslandPositions = new Vector4[islandPositions.Length + sdfIslandSFGParameter.islandPositions.Length];
        var newIslandParameters = new Vector4[islandParameters.Length + sdfIslandSFGParameter.islandParameters.Length];
        Array.Copy(islandPositions, newIslandPositions, islandPositions.Length);
        Array.Copy(sdfIslandSFGParameter.islandPositions, 0, newIslandPositions, islandPositions.Length,
            sdfIslandSFGParameter.islandPositions.Length);
        Array.Copy(islandParameters, newIslandParameters, islandParameters.Length);
        Array.Copy(sdfIslandSFGParameter.islandParameters, 0, newIslandParameters, islandParameters.Length,
            sdfIslandSFGParameter.islandParameters.Length);
