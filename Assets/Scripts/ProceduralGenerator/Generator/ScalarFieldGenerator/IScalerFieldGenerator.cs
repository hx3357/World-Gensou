...
/// <summary>
/// This module is an encapsulation of a specific compute shader.
/// <para></para> 
/// </summary>
public interface IScalerFieldGenerator
{
    ...
    /// 
    /// </summary>
    /// <param name="scalerFieldRequestData"></param>
    /// <param name="isNotGetDotfield"></param>
    /// <returns></returns>
    public (bool isDone, Dot[] dotField, bool zeroFlag) GetState(ref ScalerFieldRequestData scalerFieldRequestData,
