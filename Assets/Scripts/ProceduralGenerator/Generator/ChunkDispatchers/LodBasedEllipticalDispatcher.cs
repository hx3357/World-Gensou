...
public class LodBasedEllipticalDispatcher : IChunkDispatcher
{
    // enum LODLevel
    // {
    //     High,Mid,Low
    // }
    //
    // private readonly Dictionary<LODLevel,int> lodLevelToChunkResolution = new()
    // {
    //     {LODLevel.High,31},
    //     {LODLevel.Mid,15},
    //     {LODLevel.Low,7}
    ...
    public LodBasedEllipticalDispatcher(float xzRadius, float yRadius)
    {
